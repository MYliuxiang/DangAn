...
- (IBAction)DoneAction:(id)sender {
    ...
    [self.delegate clickcontentString:_textField_num.text lxView:self image:_image];
    [self dismiss];
}
...
- (void)clickcontentString:(NSString *)contentString lxView:(NewDAView *)alert{
