...
- (void)createSubViews
{
    ...
    separator.frame = CGRectMake(0, titleHeight + confirmHeight, SCREEN_WIDTH, 10);
    ...
    [cancel setTitleColor:Color_blue forState:UIControlStateNormal];
...
- (void)tapAction
{
    ...
    [self.delegate clickAction:self atIndex:990];
