...
//        _pointA.alpha=0.5;_pointB.alpha=0.5;_pointC.alpha=0.5;_pointD.alpha=0.5,_pointE.alpha=0.5,_pointF.alpha=0.5,_pointG.alpha=0.5,_pointH.alpha=0.5;
        ...
        //COLOR
        _pointA.backgroundColor=[UIColor clearColor];
         _pointB.backgroundColor=[UIColor clearColor];
         _pointC.backgroundColor=[UIColor clearColor];
         _pointD.backgroundColor=[UIColor clearColor];
        
        //middle
        _pointE.backgroundColor=[UIColor clearColor];
        _pointF.backgroundColor=[UIColor clearColor];
        _pointG.backgroundColor=[UIColor clearColor];
        _pointH.backgroundColor=[UIColor clearColor];
...
- (void)setButtons
{
    ...
    UIImageView *imageViewA = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, _pointA.width, _pointA.height)];
    imageViewA.image = [UIImage imageNamed:@"图标调整"];
    imageViewA.userInteractionEnabled = YES;
    [_pointA addSubview:imageViewA];
    
    UIImageView *imageViewB = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, _pointA.width, _pointA.height)];
    imageViewB.image = [UIImage imageNamed:@"图标调整"];
    imageViewB.userInteractionEnabled = YES;
    [_pointB addSubview:imageViewB];
    
    UIImageView *imageViewC = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, _pointA.width, _pointA.height)];
    imageViewC.image = [UIImage imageNamed:@"图标调整"];
    imageViewC.userInteractionEnabled = YES;
    [_pointC addSubview:imageViewC];
    
    UIImageView *imageViewD = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, _pointA.width, _pointA.height)];
    imageViewD.image = [UIImage imageNamed:@"图标调整"];
    imageViewD.userInteractionEnabled = YES;
    [_pointD addSubview:imageViewD];
    
    UIImageView *imageViewE = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, _pointA.width, _pointA.height)];
    imageViewE.image = [UIImage imageNamed:@"图标调整"];
    imageViewE.userInteractionEnabled = YES;
    [_pointE addSubview:imageViewE];
    
    UIImageView *imageViewF = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, _pointA.width, _pointA.height)];
    imageViewF.image = [UIImage imageNamed:@"图标调整"];
    imageViewF.userInteractionEnabled = YES;
    [_pointF addSubview:imageViewF];
    
    UIImageView *imageViewG = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, _pointA.width, _pointA.height)];
    imageViewG.image = [UIImage imageNamed:@"图标调整"];
    imageViewG.userInteractionEnabled = YES;
    [_pointG addSubview:imageViewG];
    
    UIImageView *imageViewH = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, _pointA.width, _pointA.height)];
    imageViewH.image = [UIImage imageNamed:@"图标调整"];
    imageViewH.userInteractionEnabled = YES;
    [_pointH addSubview:imageViewH];
...
//        CGContextSetRGBFillColor(context, 0.0f, 0.0f, 0.0f, 0.7f);
        ...
        if([self checkForNeighbouringPoints:currentIndex]>=0 ){
            frameMoved=YES;
             CGContextSetRGBStrokeColor(context, 1.0f, 180 / 255.0f, 0.0f, 1.0f);
